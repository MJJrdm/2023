...
<template>
  <div class="box">
    ...
    <div class="box-middle">
      ...
      <div class="login-but cur-poi" @click.left="resetPassword">
        重置
      </div>
    </div>
    <div class="box-foot">
      <div> </div>
      <div class="cur-poi" @click="goLogin">已有账号，去登录</div>
    </div>
  </div>
</template>
...
export default {
  ...
  methods: {
    resetPassword() {
      this.$api.puzzle.resetPassword({username: this.account, password: this.password}).then(() => {
